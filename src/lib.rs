...
#[derive(Debug)]
pub struct NeoCodeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NeoCodeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NeoCode processing");
    
    let mut processor = NeoCodeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NeoCodeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NeoCodeProcessor::new(false);
